...
- Moved SDLC process docs into audience-based structure:
  - Agent docs: `docs/process/sdlc/agent/SDLC_AGENT_{AUTHORITY_MAP,SESSION_BOOTSTRAP,EXECUTION_RUNBOOK}.md`
  - Human docs: `docs/process/sdlc/human/SDLC_HUMAN_{PROCESS_GUIDE,DRIVER_PROMPTS}.md`
- Replaced `.github/agents/templates/TWO_PROMPTS.md` with `docs/process/sdlc/human/SDLC_HUMAN_DRIVER_PROMPTS.md`.
- Added `docs/process/sdlc/README.md` as audience/naming index.
