...
**Architecture ADRs**:
- [ADR_M7_BOUNDED_PERSONALIZATION_POLICY.md](ADRS/ADR_M7_BOUNDED_PERSONALIZATION_POLICY.md)
- [ADR_M7_LOGIT_THEN_BANDIT_GATING.md](ADRS/ADR_M7_LOGIT_THEN_BANDIT_GATING.md)
