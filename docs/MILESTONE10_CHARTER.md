# Milestone 10 --- Helionyx Lab (Learning, LLMs, and Controlled Experimentation)
...
After Milestone 9, users can operate tasks and inspect system behavior, but
cannot yet deeply inspect or govern learning internals from the UI.

Milestone 10 turns learning and model behavior into first-class operator
...
- Existing tasks/control-room functionality remains non-regressive
...
6. Validate regression coverage
	- Re-run Milestone 9 task/control-room checks
